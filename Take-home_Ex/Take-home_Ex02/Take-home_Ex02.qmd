...
First of all, I'll follow the steps my classmate has done. - Install relevant R packages:
...
The original design is shown as below: ![critique1_original](image/critique1_original.png)
The 3 histograms show the distribution of average score of Math, Reading and Science.
...
To display 3 density distributions in one graph, I need to create a new column called "Subject" to capture all the subject names of each student and a new column called "Score" to capture all the score values of each student. 
I use `pivot_longer()` to convert the dataframe from wide format into long format.
...
The original design is shown as below: ![critique2_original](image/critique2_original.png)
This graph shows the distributions of average score of all the 3 subjects across all socioeconomic groups.

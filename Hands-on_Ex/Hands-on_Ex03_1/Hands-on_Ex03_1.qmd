...
Now you can get 3 information based on the scatter plot:
...
Now you can see a side-by-side plot with a scatter plot on the left and a data table on the right, there are 3 interactive function in this plot:
